...
The video with the result of the 3rd exercise simulation can be [downloaded here](https://github.com/vitoramr/Numerical_simulation_pendulum/blob/main/EP3/EP3_Vid.mp4?raw=true).
